...
/* Los dos botones flotantes: WhatsApp y «volver arriba». */
export default function Flotantes({ mostrarSubir }) {
  const texto = '¡Hola Candylandia! Quiero información sobre sus dulces de importación.';
